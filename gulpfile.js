...
const { startUI, startElectron, startGateway, startNyaa, startMyAnimeList, startYoutubeDL, startAtlas } = require("./scripts/gulp.start");
...
const start = parallel(startUI, startElectron, startGateway, startNyaa, startMyAnimeList, startYoutubeDL, startAtlas);
